...
<f:view>
	<rich:page theme="simple" pageTitle="Modifier une periode d'etude "
		...
		<a4j:form>
			<rich:panel header="Modifier une periode d'etude">
				<a4j:form>
					...
					<h:panelGrid columns="2">
						...
						<h:outputText value=" Anciens Cours :" />
						<rich:panel>
						...
						<h:outputText value="Nouveaux Cours :" />
						...
						<f:facet name="footer">
							<a4j:commandButton value="OK"
								action="#{periodeDetude.mergePeriodeDetude}" />
						</f:facet>
					</h:panelGrid>
